...
export default function Navbar() {
  ...
  return (
    <div className="w-full py-5 bg-secondary">
      <div className="px-5 xl:px-0 max-w-7xl mx-auto flex items-center justify-between">
        <div>
          ...
          >
            ...
            <p className="text-2xl font-semibold">Tanvir Hasan Emon</p>
          </Link>
        </div>
        ...
        <div className="block lg:hidden ">
          ...
          {toggle && (
            <div className="p-5 absolute black-gradient top-16 black-gradient right-0 min-w-[50%] mr-5 z-10 rounded-xl">
