      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 gap-10">
          {projects.map((project, index) => (
            <div
              className="flex flex-col hover:-translate-y-3 lg:flex-row gap-10 items-center border-2 border-primary p-10 rounded-xl shadow-md shadow-primary duration-1000 cursor-pointer"
              key={index}
            >
